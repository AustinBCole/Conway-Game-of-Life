        ...
        for y in 0...Int(bounds.maxY / 10) {
            for x in 0...Int(bounds.maxX / 10) {
                ...
                // Else if we are still on the first row of cells
                    ...
                    let cell = UIView(frame: CGRect(x: x * 10, y: y, width: 10, height: 10))
                ...
                // Else in the case that we are on the first column of cells
                    ...
                    let cell = UIView(frame: CGRect(x: x, y: y * 10, width: 10, height: 10))
                ...
                // Else
                    ...
                    let cell = UIView(frame: CGRect(x: x * 10, y: y * 10, width: 10, height: 10))
